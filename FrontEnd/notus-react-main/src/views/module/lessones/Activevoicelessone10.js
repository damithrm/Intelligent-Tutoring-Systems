...
export default function Activevoicelessone10() {
          ...
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
              <p className="text-blueGray-600 text-md mt-3 mb-6 ">
                This tense is used to refer to actions or events that will be in
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  >
                    Subject + Auxiliary will (will) + Auxiliar be (be) + Main
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    I <label className="font-bold">will be lying </label>on a
                    beach tommorow.
                  </li>
                  <li>
                    You <label className="font-bold">will be working </label>at
                    10am.
                  </li>
                </ul>
              </div>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Subject + Auxiliary will (will) + not + Auxiliar be (be) +
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    She <label className="font-bold">will not be using </label>
                    the car.
                  </li>
                  <li>
                    We <label className="font-bold">will not be having </label>
                    dinner at home.
                  </li>
                </ul>
              </div>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Auxiliary will (will) + Subject + Auxiliar be (be) + Main
                    Verb (Present Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    ...
                    <label className="font-bold">be playing </label>football?
                  </li>
                  <li>
                    <label className="font-bold">Will </label>they{" "}
                    <label className="font-bold">be watching </label>TV?
                  </li>
                </ul>
              </div>
              <br />
