...
export default function Activevoicelessone11() {
          ...
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
              <p className="text-blueGray-600 text-md mt-3 mb-6 ">
                We use the future perfect tense to say that an action or event
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    I <label className="font-bold">will have finished </label>at
                    10am.
                  </li>
                  <li>
                    You{" "}
                    <label className="font-bold">will have forgotten </label>me
                    by then.
                  </li>
                </ul>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    She <label className="font-bold">will not have gone </label>
                    to school.
                  </li>
                  <li>
                    We <label className="font-bold">will not have left.</label>
                  </li>
                </ul>
              </div>
              <br />
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    ...
                    <label className="font-bold">have arrived?</label>
                  </li>
                  <li>
                    <label className="font-bold">Will </label>they{" "}
                    <label className="font-bold">have recieved </label>it?
                  </li>
                </ul>
              </div>
              <br />
