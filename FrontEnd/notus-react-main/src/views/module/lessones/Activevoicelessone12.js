...
export default function Activevoicelessone12() {
          ...
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
              <p className="text-blueGray-600 text-md mt-3 mb-6 ">
                The future perfect continuous is used to describe actions and
                events that, at some point in the future, will have already
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  >
                    Subject + Auxiliary will (will) + Auxiliary have (have) +
                    Auxiliary be (been) + Main Verb (Present Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    I{" "}
                    <label className="font-bold">will have been working </label>
                    for four hours.
                  </li>
                  <li>
                    You{" "}
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Subject + Auxiliary will (will) + not + Auxiliary have
                    (have) + Auxiliary be (been) + Main Verb (Present
                    Participle)
                  </label>
                </div>
              </div>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Auxiliary will (will) + Subject + Auxiliary have (have) +
                    Auxiliary be (been) + Main Verb (Present Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    <label className="font-bold">Will </label>you{" "}
                    <label className="font-bold">have been playing </label>
                    football?
                  </li>
                  <li>
                    <label className="font-bold">Will </label>they{" "}
                    <label className="font-bold">have been watching </label>TV?
                  </li>
                </ul>
              </div>
              <br />
