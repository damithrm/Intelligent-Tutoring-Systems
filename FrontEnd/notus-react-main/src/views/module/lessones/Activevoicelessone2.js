...
export default function Activevoicelessone2() {
  ...
  const getData = () => {
    fetch('http://localhost:8000/questionBank/selectquestion')
      ...
      .then((res) => {
        fetchquestion(res);
        fetchquestion1(res.filter(test => test.lessoneId === 2));
          ...
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
              <p className="text-blueGray-600 text-md mt-3 mb-6 ">
                ...
                condition is happening now, frequently, and may continue into
                the future.
              </p>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  >
                    Subject + Auxiliar be (am/ is/ are) + Main Verb (Present
                    Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    I <label className="font-bold">am speaking </label>to you.
                  </li>
                  <li>
                    He <label className="font-bold">is staying </label>in
                    London.
                  </li>
                  <li>
                    You <label className="font-bold">are reading </label>this.
                  </li>
                </ul>
              </div>
              <br />
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Subject + Auxiliar be (am/ is/ are) + not + Main Verb
                    (Present Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    I <label className="font-bold">am not speaking </label>to
                    you.
                  </li>
                  <li>
                    She <label className="font-bold">is staying </label>in
                    London.
                  </li>
                  <li>
                    They <label className="font-bold">are not playing </label>
                    football.
                  </li>
                </ul>
              </div>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Auxiliar be (Am/ Is/ Are) + Subject + Main Verb (Present
                    Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    <label className="font-bold">Is </label>he{" "}
                    <label className="font-bold">watching </label>TV?
                  </li>
                  <li>
                    <label className="font-bold">Are </label>they{" "}
                    <label className="font-bold">waiting </label>for John?
                  </li>
                </ul>
              </div>
              <br />
          ...
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            <div className="rounded-t bg-white mb-0 px-6 py-6">
              <div className="text-center flex justify-between">
                ...
                {quiz? ( <span>Questions</span>): (<button
                onClick={handlequiz}
