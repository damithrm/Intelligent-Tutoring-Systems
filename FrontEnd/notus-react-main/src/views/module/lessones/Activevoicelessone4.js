...
export default function Activevoicelessone4() {
          ...
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
              <p className="text-blueGray-600 text-md mt-3 mb-6 ">
                In this verb tense, the action starts in the past but it’s still
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  >
                    Subject + Auxiliary have (has/ have) + Auxiliary be (been) +
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    I <label className="font-bold">have been waiting </label>for
                    one hour.
                  </li>
                  <li>
                    You{" "}
                    <label className="font-bold">have have been talking </label>
                    too much.
                  </li>
                </ul>
              </div>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Subject + Auxiliary have (has/ have) + not + Auxiliary be
                    (been) + Main Verb (Present Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    It{" "}
                    <label className="font-bold">has not been raining.</label>
                  </li>
                  <li>
                    We{" "}
                    <label className="font-bold">have not been playing </label>
                    football.
                  </li>
                </ul>
              </div>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Auxiliary have (Has/ Have) + Subject + Auxiliary be (been) +
                    Main Verb (Present Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    ...
                    <label className="font-bold">been seeing </label> her?
                  </li>
                  <li>
                    <label className="font-bold">Have </label>they{" "}
                    <label className="font-bold">been doing </label>their home
                    work?
                  </li>
                </ul>
              </div>
