...
export default function Activevoicelessone5() {
          ...
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
              <p className="text-blueGray-600 text-md mt-3 mb-6 ">
                The past simple is used to describe past actions and events that
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  >
                    Subject + Main Verb (Past Simple)
                    <br />
                    Subject + Main Verb be (was/ were)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    I <label className="font-bold">went </label>to school.
                  </li>
                  <li>
                    he <label className="font-bold">worked </label>very hard.
                  </li>
                  <br />
                  <li>
                    She <label className="font-bold">was </label>here.
                  </li>
                  <li>
                    You <label className="font-bold">were </label>in London.
                  </li>
                </ul>
              </div>
              <br />
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Subject + Auxiliary do (did) + not + Main Verb (Base)
                    <br />
                    Subject + Main Verb be (was/ were) + not
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    She <label className="font-bold">did not go </label>with me.
                  </li>
                  <li>
                    We <label className="font-bold">did not work </label>
                    yesterday.
                  </li>
                  <br />
                  <li>
                    I <label className="font-bold">was not </label>there.
                  </li>
                  <li>
                    They <label className="font-bold">were not </label>happy.
                  </li>
                </ul>
              </div>
              <br />
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Auxiliary do (Did) + Subject + Main Verb (Base)
                    <br />
                    Main Verb be (Was/ Were) + Subject
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    <label className="font-bold">Did </label>you{" "}
                    <label className="font-bold">go </label>to London?
                  </li>
                  <li>
                    <label className="font-bold">Did </label>he{" "}
                    <label className="font-bold">work </label>at home?
                  </li>
                  <br />
                  <li>
                    <label className="font-bold">Was </label>I{" "}
                    <label className="font-bold">right?</label>
                  </li>
                  <li>
                    <label className="font-bold">Were </label>they{" "}
                    <label className="font-bold">late?</label>
                  </li>
                </ul>
              </div>
              <br />
