...
export default function Activevoicelessone6() {
          ...
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
              <p className="text-blueGray-600 text-md mt-3 mb-6 ">
                The past continuous tense is used to express the occurring
                circumstance or any continuing action that has happened in the
                past.
              </p>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  >
                    Subject + Auxiliar be (was/ were) + Main Verb (Present
                    Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    I <label className="font-bold">was watching </label>TV.
                  </li>
                  <li>
                    You <label className="font-bold">were working </label>hard.
                  </li>
                </ul>
              </div>
              <br />
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Subject + Auxiliar be (was/ were) + not + Main Verb (Present
                    Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    Hw <label className="font-bold">was not helping </label>
                    Mary.
                  </li>
                  <li>
                    We <label className="font-bold">were not joking.</label>
                  </li>
                </ul>
              </div>
              <br />
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Auxiliar be (Was/ Were) + Subject + Main Verb (Present
                    Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    <label className="font-bold">Was </label>she{" "}
                    <label className="font-bold">being silly?</label>
                  </li>
                  <li>
                    <label className="font-bold">Were </label>they{" "}
                    <label className="font-bold">playing </label>football?
                  </li>
                </ul>
              </div>
              <br />
