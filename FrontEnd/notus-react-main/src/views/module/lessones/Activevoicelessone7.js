...
export default function Activevoicelessone7() {
          ...
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
              <p className="text-blueGray-600 text-md mt-3 mb-6 ">
                The past perfect is used to talk about actions and events that
                happened before another action or before a specific time in the
                past.
              </p>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  >
                    Subject + Auxiliary have (had) + Main Verb (Past Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    I <label className="font-bold">had finished </label>my work.
                  </li>
                  <li>
                    You <label className="font-bold">had stopped </label>before
                    me.
                  </li>
                </ul>
              </div>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Subject + Auxiliary have (had) + not + Main Verb (Past
                    Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    She <label className="font-bold">had not gone </label>to
                    school.
                  </li>
                  <li>
                    We <label className="font-bold">had not left.</label>
                  </li>
                </ul>
              </div>
              <br />
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Auxiliary have (Had) + Subject + Main Verb (Past Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    ...
                    <label className="font-bold">arrived?</label>
                  </li>
                  <li>
                    <label className="font-bold">Had </label>they{" "}
                    <label className="font-bold">eaten </label>dinner?
                  </li>
                </ul>
              </div>
              <br />
