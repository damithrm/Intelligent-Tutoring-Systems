...
export default function Activevoicelessone8() {
          ...
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
              <p className="text-blueGray-600 text-md mt-3 mb-6 ">
                We use the past perfect continuous to talk about actions and
                events that started in the past and lasted until another action
                or event in the past happened.
              </p>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  >
                    Subject + Auxiliary have (had) + Auxiliary be (been) + Main
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    I <label className="font-bold">had been working.</label>
                  </li>
                  <li>
                    You <label className="font-bold">had been playing </label>
                    tennis.
                  </li>
                </ul>
              </div>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Subject + Auxiliary have (had) + not + Auxiliary be (been) +
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    It{" "}
                    <label className="font-bold">had not been working </label>
                    well.
                  </li>
                  <li>
                    We{" "}
                    <label className="font-bold">had not been expecting </label>
                    her.
                  </li>
                </ul>
              </div>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Auxiliary have (Had) + Subject + Auxiliary be (been) + Main
                    Verb (Present Participle)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    <label className="font-bold">Had </label>you{" "}
                    <label className="font-bold">been drinking?</label>
                  </li>
                  <li>
                    <label className="font-bold">Had </label>they{" "}
                    <label className="font-bold">been waiting </label>long?
                  </li>
                </ul>
              </div>
              <br />
