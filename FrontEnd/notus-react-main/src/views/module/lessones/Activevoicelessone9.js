...
export default function Activevoicelessone9() {
          ...
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
              <p className="text-blueGray-600 text-md mt-3 mb-6 ">
                We use the future simple mainly for predictions and spontaneous
                decisions.
              </p>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  >
                    Subject + Auxiliary will (will) + Main Verb (Base)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    I <label className="font-bold">will open </label>the door.
                  </li>
                  <li>
                    You <label className="font-bold">will finish </label>before
                    me.
                  </li>
                </ul>
              </div>
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Subject + Auxiliary will (will) + not + Main Verb (Base)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    She <label className="font-bold">will not be </label>at
                    school tommorow.
                  </li>
                  <li>
                    We <label className="font-bold">will not leave </label>yet.
                  </li>
                </ul>
              </div>
              <br />
              ...
              <div class="flex items-center">
                ...
                <div className="relative w-2/4 mb-3 text-center border-4 border-orange-400">
                  ...
                  <label
                    ...
                    htmlFor="grid-password"
                  >
                    Auxiliary will (will) + Subject + Main Verb (Base)
                  </label>
                </div>
              </div>
              ...
              <div className="relative my-3 mr-4">
                ...
                >
                  <li>
                    ...
                    <label className="font-bold">arrive </label>on time?
                  </li>
                  <li>
                    <label className="font-bold">Will </label>they{" "}
                    <label className="font-bold">want </label>dinner?
                  </li>
                </ul>
              </div>
              <br />
